...
<a href="http://www.textures.com/about">About</a>
<img class="right_arrow" height="11" src="/images/right_arrow.png" width="6">
</img></li>
<li class="">
<a href="http://www.textures.com/people">Photographers</a>
</li>
<li class="">
<a href="http://www.textures.com/privacy.html">Privacy Policy</a>
</li>
</ul>
</div>
<div class="sidebar_in" id="sidebar_in" style="min-height: 293px;">
<div class="wrapper" style="padding:30px 60px;">
...
<div style="border-radius: 4px 4px 0 0; clear:both">
<div class="page_text">
<p>Textures.com is a website that offers digital pictures of all sorts of materials. We have pictures of <a href="http://www.textures.com/search?q=fabric">fabrics</a>, <a href="http://www.textures.com/search?q=wood">wood</a>, <a href="http://www.textures.com/search?q=metal">metal</a>, <a href="http://www.textures.com/search?q=brick">bricks</a>, <a href="http://www.textures.com/search?q=plastic">plastic</a>, and many more. These images are called textures and can be used for graphic design, visual effects, in computer games and any other situation where you need a <a href="http://www.textures.com/browse/stucco/95377">nice pattern</a> or <a href="http://www.textures.com/category/abstract/112391">background image</a>.<br/></p>
<div style="height:20px"> </div>
<p>You can download up to 15 images for free every day. If you need more or bigger images, you can purchase a credit pack or a subscription. The <a href="http://www.textures.com/howItWorks">How it works</a> page has more information about download quotas.</p>
<div style="height:20px"> </div>
<p>Our website was founded in 2005 as CGTextures.com, our images have been used by practically every game developer and Visual Effects company in the world. Our library currently has 121,131 images, and continues to <a href="http://www.textures.com/homeNews">grow every week</a>.</p>
</div>
</div>
</div>
</div>
...
<div class="testimonials" style="height:316px; width:100%;">
<div class="testimonials_image active_t" style=" background: url(003.jpg); width:100%; ">
<div style="width:345px;">
<p class="name">Raphael Lacoste</p>
<p class="info">Matte Painter and concept artist</p>
<p class="testimonial">“Textures.com is a big help to me in creating textures for my projects. I have never seen such a quality in pictures or such a diversity in roof textures as I find in CGTextures!<br><br>Your website is amazing! ”</br></br></p>
</div>
</div>
<div class="testimonials_image" style="background: url(lahore.jpg);  width:100%">
<div style="width:345px;">
<p class="name">Misja Baas</p>
<p class="info">Senior Artist Guerrilla-Games</p>
<p class="testimonial">“ Textures.com is one of our primary resource sites for texture work on Killzone.<br/><br/>It is one of the best texture resource sites on the Web! ”</p>
</div>
</div>
<div class="testimonials_image" style="background: url(Islamabad.jpg);">
<div style="width:345px;">
<p class="name">Andrew Averkin</p>
<p class="info">CG Artist</p>
<p class="testimonial">“ I want to say you huge thanks for such great website with such amazing textures! ”</p>
</div>
</div>
<div class="testimonials_image" style="background: url(01.jpg); display: none">
<div style="width:345px;">
<p class="name">Justin Holt</p>
<p class="info">Lead Texture Painter</p>
<p class="testimonial">“ For anybody who is serious about texture painting, Textures.com is the place to get what you need.<br/><br/>Without question, one of the best reference sites out there. ”</p>
</div>
</div>
</div>
<div class="active_testimonial"><div class="dots active_dot" style="background: url(04.jpg)"></div><div class="dots" style="background: url(/images/testimonial_active.png)"></div><div class="dots" style="background: url(/images/testimonial_active.png)"></div><div class="dots" style="background: url(/images/testimonial_active.png)"></div></div>
</div>


<div class="wrapper" style="border-radius: 4px 4px 0 0">
<p class="section_title">Our Clients</p>
<div style="text-align:center">
<img alt="Clients" height="175" src="images/client_logos.png" width="839">
</img></div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        var testimonials = 4;
        var dots = "<div class='dots' style='background: url(images/testimonial_active.png)'></div>";
        ...
        function changeTestimonial(i){
            return function(){
                ...
                $(".testimonials_image").eq(i).fadeIn(300);

                $(".testimonials_image").removeClass("active_t");
                $(".dots").removeClass("active_dot");
                $(".testimonials_image").eq(i).addClass("active_t");
        ...
        /**
         * Initialize testimonial's (small) dot/cicle click event
         */
        for(var i=0; i<testimonials; i++){
            $('.dots').eq(i).click(changeTestimonial(i));
        }
        ...
        function repeatOften() {
            if (window.intervalCount >= 300) { // 60fps x 5 = 300 (5 seconds)
                testimonialTicker();
                // Reset interval counter
                window.intervalCount = 0;
            } else {
                // Increment, till we get to 300 (5 seconds)
...
<p class="copyright_big">Copyright © 2005 - 2017, Textures.com</p>
</div>
</div>
</div>
<script src="/js/jquery.form.min.js" type="text/javascript"></script>
<!--<script src="/js/common.js?v=2017102109" type="text/javascript"></script> -->
